            ...
            >
              <Card className="group relative overflow-hidden rounded-2xl border border-white/10 transition-all hover:border-white/20 hover:shadow-2xl" style={{ background: 'linear-gradient(145deg, rgba(15,30,50,0.6), rgba(10,22,40,0.8))' }}>
                ...
                <CardContent className="relative p-5">
                  {/* Icon at top - smaller */}
                  <div
                    className="inline-flex h-10 w-10 items-center justify-center rounded-xl shadow-lg"
                  ...
                  <div className="mt-3">
                    ...
                    <div className="mt-1 text-3xl font-bold text-foreground">{stat.value}</div>
                  ...
                  {stat.trend && (
                    <div className="mt-2.5">
                      <span className={cn('inline-flex items-center gap-1.5 rounded-md px-2 py-0.5 text-[11px] font-medium', stat.textColor)} style={{ background: stat.iconBg }}>
                        {stat.trend}
                      </span>
                    </div>
                  )}
